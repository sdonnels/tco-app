...
- **Generate Intake Form** — Opens the Excel intake form export dialog (same as Tools tab)
- **Import Intake Data** — Uploads completed intake form (.xlsx or .csv) to auto-populate tool fields
